...
class OrderRefund(TimeStampedModel):
    ...
    refund_type = models.CharField(
        max_length=10, choices=REFUND_TYPE_CHOICES, default="FULL"
    )
    amount = models.DecimalField(max_digits=10, decimal_places=2)
    reason = models.TextField()
    status = models.CharField(
        max_length=10, choices=REFUND_STATUS_CHOICES, default="REQUESTED"
    )
...
class Coupon(TimeStampedModel):
    ...
    coupon_type = models.CharField(
        max_length=15, choices=COUPON_TYPE_CHOICES, default="PERCENTAGE"
    )
