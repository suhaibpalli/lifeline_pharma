...
def patient_profile_upload_to(instance, filename):
    """Generate upload path for patient profile images"""
    ext = filename.split(".")[-1]
    return f"profiles/patient/{instance.user.id or 'new'}/{filename}"


def pharmacy_document_upload_to(instance, filename):
    """Generate upload path for pharmacy documents"""
    ext = filename.split(".")[-1]
    return f"profiles/pharmacy/{instance.user.id or 'new'}/{filename}"
